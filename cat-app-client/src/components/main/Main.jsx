                ...
                <>
                    <GeneralWrapper>
                        <div style={topPaddingStyle}>
                            {currentCat.goalWeight && (
                                <h1>목표 체중 : {currentCat.goalWeight} kg</h1>
                            )}
                        </div>
                        <div style={topPaddingStyle}>
                            <h4>
                        ...
                        {currentCat.photo &&
                        currentCat.photo !==
                            '/home/admin/app/step1/Project_Cats/catchoo-server/build/libs/null' ? (
                            <PhotoContainer
                                style={{
                                    backgroundImage: `url(${currentCat.photo})`,
                                }}
                            />
                        ) : (
                            <PhotoContainer>
                        ...
                        <WeightRecordWrapper>
                            ...
                            <h2>
                                {currentCat.recentRecord
                                    ? currentCat.recentRecord.createdDate.slice(
                                          0,
                                          10
                                      )
                                    : '체중을'}
