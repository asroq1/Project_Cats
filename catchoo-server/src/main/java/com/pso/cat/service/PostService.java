...
public class PostService {
    ...
    public Post save(Long userId, PostDto.Request postDto, MultipartFile photoFile) throws Exception {

        //포토파일이 빈 것이 들어오면 빈 것을 반환
        ...
        if (!photoFile.isEmpty()) {
            ...
            if (ObjectUtils.isEmpty(contentType)) {
                ...
                // 다른 파일 명이면 아무 일 하지 않는다
                    ...
                    out.println("<script>alert('잘못된 확장자입니다.'); location.href='/'; </script>");
                    out.close();
                    return null;
                }
            }
